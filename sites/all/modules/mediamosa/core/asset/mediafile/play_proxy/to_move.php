 ...
 *
 * @param v_width mediafile width
 * @param v_height mediafile height
 * @param width play proxy call parameter width
 * @param height play proxy call parameter height
 *
 * @return array with new width en height.
 *
 */
function _play_proxy_calc_video_size($v_width, $v_height, $width, $height, $container_type) {
  ...
  if (!(($width > 0) && ($height > 0))) {
    ...
    $width = PP_FLASH_OBJECT_WIDTH;
    $height = PP_FLASH_OBJECT_HEIGHT;
  }
